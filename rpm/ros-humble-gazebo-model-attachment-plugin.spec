...
Name:           ros-humble-gazebo-model-attachment-plugin
Version:        1.0.3
Release:        2%{?dist}%{?release_suffix}
Summary:        ROS gazebo_model_attachment_plugin package

License:        Apache-2.0
Source0:        %{name}-%{version}.tar.gz

Requires:       ros-humble-gazebo-dev
Requires:       ros-humble-gazebo-model-attachment-plugin-msgs
...
BuildRequires:  ros-humble-gazebo-model-attachment-plugin-msgs
...
%changelog
* Wed Dec 20 2023 Boeing <Jason.Cochrane@boeing.com> - 1.0.3-2
- Autogenerated by Bloom

* Tue Dec 19 2023 Boeing <Jason.Cochrane@boeing.com> - 1.0.3-1
- Autogenerated by Bloom
